...
const searchH7 = () => {
  ...
  const result = h7bl.find((code) => code.tariffCode === input);
  if (input !== "") {
    if (
      result ||
      h7TwoDigitCodes.includes(input.substring(0, 2)) ||
      h7FourDigitCodes.includes(input.substring(0, 4))
    ) {
